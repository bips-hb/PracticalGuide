...
knitr::include_graphics('Search_algorithms-v6-9.png')
```
...
knitr::include_graphics('Search_algorithms_options-v6-9.png')
```
...
knitr::include_graphics('TrueDAG_cohortsim_fto.eps')
```
...
knitr::include_graphics('T0_cross_section_mixed_data_search-24August2021.png')
```
...
knitr::include_graphics('Tetrad_Tier_node_setup.png')
```
...
knitr::include_graphics('TierInput_v4.png')
```
...
knitr::include_graphics('ForbiddenRequired_v3.png')
```
...
knitr::include_graphics('tetrad-tiers-2timepoints.png')
```
...
knitr::include_graphics('search-algorithm-missing-warning.png')
```
...
knitr::include_graphics('missing-data-results-tpc.png')
```
